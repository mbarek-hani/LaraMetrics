...
@php
    $classes = [
        'succes' => 'bg-emerald-50 border-emerald-200 text-emerald-700 border-l-4 border-l-emerald-500',
...
<div x-data="{ show: true }" x-init="setTimeout(() => show = false, 5000)" x-show="show"
    ...
    x-transition:leave-end="opacity-0 transform translate-x-8" class="fixed top-4 right-4 z-[100] w-full max-w-sm"
    x-cloak>
