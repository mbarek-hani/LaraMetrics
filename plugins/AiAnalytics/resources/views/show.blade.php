<x-app-layout titre="Détails du rapport IA">
    ...
    <div class="p-ai p-container p-container--md">
        ...
        <div class="p-actions p-mt-2 p-mb-2">
            <x-button href="{{ route('plugins.ai-analytics.historique.index') }}" variant="secondary" size="sm">
        ...
        <x-card>
            <div class="p-ai__report-layout">
                <div class="p-ai__score-circle p-ai__score-circle--lg">
                    <span class="p-ai__score-value" style="color: {{ $rapport->score >= 7 ? 'var(--success-text)' : ($rapport->score >= 4 ? 'var(--warning-text)' : 'var(--error-text)') }}">
                        {{ $rapport->score }}
                    </span>
                ...
                <div class="p-ai__report-content">
                    <div class="p-row p-mb-2 p-row--wrap">
                        <h1 class="p-section__title" style="font-size: 1.125rem;">Analyse du site : {{ $rapport->site->nom }}</h1>
                        <span class="p-badge {{ $rapport->score >= 7 ? 'p-badge--success' : ($rapport->score >= 4 ? 'p-badge--warning' : 'p-badge--error') }}">
